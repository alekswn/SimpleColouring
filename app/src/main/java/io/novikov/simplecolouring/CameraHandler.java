...
public class CameraHandler {
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            Util.LogError(TAG, "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
...
*/
            ...
            switch (displayRotation) {
                ...
                case Surface.ROTATION_270:
                    ...
                    break;
                default:
                    Util.LogError(TAG, "Display rotation is invalid: " + displayRotation);
            }
            ...
            if (swappedDimensions) {
                rotatedPreviewWidth = displaySize.y;
                rotatedPreviewHeight = displaySize.x;
...
*/
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                Util.LogError(TAG, "Exception of camera config: " + e.toString());
                            }
                        }
                        ...
                        public void onConfigureFailed(
                            ...
                            Util.LogError(TAG, "Failed to configure camera");
                        }
                    }, null
            );
        } catch (CameraAccessException e) {
            Util.LogError(TAG, "Exception of creating preview session:" + e.toString());
        }
    }
    ...
    private void lockFocus() {
        try {
            ...
            Util.LogError(TAG, "Exception in lockFocus(): " + e.toString());
        }
    }
    ...
    private void runPrecaptureSequence() {
        try {
            ...
            Util.LogError(TAG, "Exception in runPrecaptureSequence(): " + e.toString());
        }
    }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    Util.LogDebug(TAG, "Image saved:" + mFile.toString());
                    unlockFocus();
                }
            };
            ...
            Util.LogError(TAG, "Exception in captureStillPicture(): " + e.toString());
        }
    }
    ...
    private void unlockFocus() {
        try {
            ...
            Util.LogError(TAG, "Exception in unlockFocus(): " + e.toString());        }
    }
     ...
     * Constructor
     */
    public CameraHandler(Context context, SurfaceTexture surfaceTexture) {
